...
public class ShootRHand : MonoBehaviour
{
    ...
    void Update()
    {
        if (OVRInput.GetDown(OVRInput.Button.SecondaryIndexTrigger) && !fire)
        {
            fire = true;
        ...
        if (OVRInput.GetUp(OVRInput.Button.SecondaryIndexTrigger) && fire)
        {
            fire = false;
        }
    }
